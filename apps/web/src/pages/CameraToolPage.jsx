      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="bg-[#111] border border-gray-700 p-6 rounded-xl mb-6">
          ...
          <div className="flex gap-4 items-center flex-wrap">
            ...
            <input
              value={camKey.toUpperCase()}
              onChange={(e) => setCamKey(e.target.value.toLowerCase().trim())}
              placeholder="0"
              className="w-24 h-14 text-center bg-black border border-yellow-400 rounded-lg shadow-[0_0_10px_rgba(255,204,0,0.5)]"
            />
          </div>
        </div>
        ...
        <div className="bg-[#111] border border-gray-700 p-6 rounded-xl mb-6">
          ...
          <div className="flex gap-4 items-center flex-wrap">
            ...
            <input
              value={tpKey.toUpperCase()}
              onChange={(e) => setTpKey(e.target.value.toLowerCase().trim())}
              placeholder="F9"
              className="w-24 h-14 text-center bg-black border border-yellow-400 rounded-lg shadow-[0_0_10px_rgba(255,204,0,0.5)]"
            />
          </div>
